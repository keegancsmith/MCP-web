...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TronGame.game_history'
        db.add_column('mcpweb_trongame', 'game_history',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TronGame.game_history'
        db.delete_column('mcpweb_trongame', 'game_history')
    ...
    models = {
        ...
        'mcpweb.trongame': {
            ...
            'player1_token': ('django.db.models.fields.CharField', [], {'default': "'LMJSOQz69XIJ'", 'max_length': '10'}),
            'player2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player2'", 'to': "orm['auth.User']"}),
            'player2_token': ('django.db.models.fields.CharField', [], {'default': "'GHv4A8NMDD39'", 'max_length': '10'}),
