...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mcpweb_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('auth_token', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
        ))
        db.send_create_signal('mcpweb', ['UserProfile'])

        if not db.dry_run:
            UserProfile = orm['mcpweb.UserProfile']
    ...
    def backwards(self, orm):
        ...
        db.delete_table('mcpweb_userprofile')
    ...
    models = {
        ...
        'mcpweb.trongame': {
            ...
            'player1_token': ('django.db.models.fields.CharField', [], {'default': "'0msspxc3rMw4'", 'max_length': '10'}),
            'player2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player2'", 'to': "orm['auth.User']"}),
            'player2_token': ('django.db.models.fields.CharField', [], {'default': "'MEgbD7LkTp1d'", 'max_length': '10'}),
        ...
        'mcpweb.userprofile': {
            ...
            'auth_token': ('django.db.models.fields.CharField', [], {'default': "'S1nLmzV6UhQv'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
